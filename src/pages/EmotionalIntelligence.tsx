...
import { Heart, Sparkles, Zap, Users, ShieldCheck, ArrowLeft, BookOpen, Quote, Calendar, MessageCircle, ExternalLink, Info, Brain } from 'lucide-react';
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">
            ...
            >
              ...
              {t('art.emotional.back')}
            </Link>
          </motion.div>
          <EditableText 
            contentId={`emotional_title_${language}`}
            defaultText={language === 'he' ? 'אינטליגנציה רגשית בזוגיות' : t('art.emotional.title')}
            as="h1"
          ...
          <div className="flex items-center justify-center gap-4 text-brand-black/40 text-xs uppercase tracking-widest">
            <EditableText 
              contentId={`emotional_subtitle_${language}`}
              defaultText={t('art.emotional.subtitle')}
              as="span"
            />
            <div className="w-1 h-1 bg-brand-gold rounded-full" />
            <EditableText 
              contentId={`emotional_reading_time_${language}`}
              defaultText={t('art.emotional.reading_time')}
              as="span"
            />
          </div>
        </motion.div>
        ...
        <div className="space-y-32">
          ...
          >
            ...
            <h2 className="text-4xl font-serif mb-10 flex items-center gap-4">
              ...
              <EditableText 
                contentId={`emotional_sec1_title_${language}`}
                defaultText={t('art.emotional.sec1.title')}
                as="span"
              />
            </h2>
            <div className="prose prose-lg prose-brand max-w-none text-brand-black/70 leading-relaxed space-y-8">
              <EditableText 
                contentId={`emotional_sec1_p1_${language}`}
                defaultText={t('art.emotional.sec1.p1')}
                as="p"
                multiline
              />
              <div className="bg-white p-10 border-r-4 border-brand-gold my-12 italic text-2xl text-brand-black/80 font-serif shadow-sm rounded-l-2xl">
                ...
                <EditableText 
                  contentId={`emotional_sec1_quote_${language}`}
                  defaultText={t('art.emotional.sec1.quote')}
                  as="span"
                  multiline
                />
              </div>
              <EditableText 
                contentId={`emotional_sec1_p2_${language}`}
                defaultText={t('art.emotional.sec1.p2')}
                as="p"
                multiline
              />
            </div>
          ...
          >
            <h2 className="text-4xl font-serif mb-10 flex items-center gap-4">
              ...
              <EditableText 
                contentId={`emotional_sec2_title_${language}`}
                defaultText={t('art.emotional.sec2.title')}
                as="span"
              />
            </h2>
            <div className="grid md:grid-cols-2 gap-16">
              <div className="space-y-8 text-brand-black/70 leading-relaxed text-lg">
                <EditableText 
                  contentId={`emotional_sec2_p1_${language}`}
                  defaultText={t('art.emotional.sec2.p1')}
                  as="p"
                  multiline
                />
                <EditableText 
                  contentId={`emotional_sec2_p2_${language}`}
                  defaultText={t('art.emotional.sec2.p2')}
                  as="p"
                  multiline
                />
              </div>
              <div className="bg-brand-cream p-10 rounded-3xl space-y-6">
                <EditableText 
                  contentId={`emotional_sec2_list_title_${language}`}
                  defaultText={t('art.emotional.sec2.list_title')}
                  as="h4"
                  className="text-xs font-black uppercase tracking-widest text-brand-gold mb-6"
                />
                <ul className="space-y-4">
                  {[
                    { id: 'item1', name: t('art.emotional.sec2.item1.name'), desc: t('art.emotional.sec2.item1.desc') },
                    { id: 'item2', name: t('art.emotional.sec2.item2.name'), desc: t('art.emotional.sec2.item2.desc') },
                    { id: 'item3', name: t('art.emotional.sec2.item3.name'), desc: t('art.emotional.sec2.item3.desc') },
                    { id: 'item4', name: t('art.emotional.sec2.item4.name'), desc: t('art.emotional.sec2.item4.desc') },
                    { id: 'item5', name: t('art.emotional.sec2.item5.name'), desc: t('art.emotional.sec2.item5.desc') }
                  ].map((item, i) => (
                    <li key={i} className="flex flex-col gap-1">
                      <EditableText 
                        contentId={`emotional_sec2_${item.id}_name_${language}`}
                        defaultText={item.name}
                        as="span"
                        className="text-base font-bold text-brand-black/80"
                      />
                      <EditableText 
                        contentId={`emotional_sec2_${item.id}_desc_${language}`}
          ...
          >
            <h2 className="text-4xl font-serif mb-10 flex items-center gap-4">
              ...
              <EditableText 
                contentId={`emotional_sec3_title_${language}`}
                defaultText={t('art.emotional.sec3.title')}
                as="span"
              />
            </h2>
            <div className="prose prose-lg prose-brand max-w-none text-brand-black/70 leading-relaxed space-y-10">
              <EditableText 
                contentId={`emotional_sec3_p1_${language}`}
                defaultText={t('art.emotional.sec3.p1')}
                as="p"
                multiline
              />
              ...
              <div className="bg-brand-black text-white p-12 rounded-[3rem] my-12">
                <EditableText 
                  contentId={`emotional_sec3_paradox_title_${language}`}
                  defaultText={t('art.emotional.sec3.paradox.title')}
                  as="h3"
                  className="text-2xl font-serif mb-6 text-brand-gold italic"
                />
                <EditableText 
                  contentId={`emotional_sec3_paradox_desc_${language}`}
                  defaultText={t('art.emotional.sec3.paradox.desc')}
                  as="p"
                  multiline
              ...
              <div className="grid sm:grid-cols-2 gap-8 my-16">
                <div className="bg-white p-10 rounded-[2rem] border border-brand-gold/10">
                  <EditableText 
                    contentId={`emotional_sec3_box1_title_${language}`}
                    defaultText={t('art.emotional.sec3.box1.title')}
                    as="h4"
                    className="text-xl font-serif mb-4 italic"
                  />
                  <EditableText 
                    contentId={`emotional_sec3_box1_desc_${language}`}
                    defaultText={t('art.emotional.sec3.box1.desc')}
                    as="p"
                    multiline
                ...
                <div className="bg-white p-10 rounded-[2rem] border border-brand-gold/10">
                  <EditableText 
                    contentId={`emotional_sec3_box2_title_${language}`}
                    defaultText={t('art.emotional.sec3.box2.title')}
                    as="h4"
                    className="text-xl font-serif mb-4 italic"
                  />
                  <EditableText 
                    contentId={`emotional_sec3_box2_desc_${language}`}
                    defaultText={t('art.emotional.sec3.box2.desc')}
                    as="p"
                    multiline
                    className="text-sm leading-relaxed"
                  />
          ...
          >
            ...
            <EditableText 
              contentId={`emotional_sources_title_${language}`}
              defaultText={t('art.emotional.sources.title')}
              as="h3"
              className="text-xl font-serif mb-4"
            />
            <EditableText 
              contentId={`emotional_sources_desc_${language}`}
              defaultText={t('art.emotional.sources.desc')}
              as="p"
              multiline
